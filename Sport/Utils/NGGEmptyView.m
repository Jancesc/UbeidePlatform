...
- (void)configueUIComponents {
    ...
    CGFloat imageHeight = 130 * self.frame.size.height / SCREEN_HEIGHT;
    CGFloat contentHeight = imageHeight + 20;
    ...
    _label.font = [UIFont systemFontOfSize:18 * 0.5 *(1 + self.frame.size.height / SCREEN_HEIGHT)];
